--library:  MADE BY Blissful#4992 ON DISCORD 
...
Library.NewWindow = function(project_name, ui_info)
    ...
    Main_Window.BackgroundColor3 = RGB(10, 10, 16)
    ...
    Pages.BackgroundColor3 = RGB(16, 8, 20)
    Pages.BorderColor3 = RGB(80, 20, 40)
    ...
    Top_Bar.BackgroundColor3 = RGB(10, 10, 16)
    ...
    Top_Bar_Border.BackgroundColor3 = RGB(251, 10, 38)
    ...
    Page_Holder.BackgroundColor3 = RGB(25, 10, 20)
    ...
    if scalable then
        ...
        ScalingSideY.BackgroundColor3 = RGB(80, 20, 40)
        ...
        ScalingSideX.BackgroundColor3 = RGB(80, 20, 40)
    ...
    structurer.Notification = function(notification_name, CallBack, info, Refuse_CallBack)
        ...
        Notification.BackgroundColor3 = RGB(25, 10, 20)
        ...
        Notif_Bar_Border.BackgroundColor3 = RGB(251, 10, 38)
    ...
    structurer.NewPage = function(page_name)
        ...
        Page_Option.BackgroundColor3 = RGB(80, 20, 40)
        ...
        page_funcs.NewCategory = function(category_name)
            ...
            Category_Background.BackgroundColor3 = RGB(20, 10, 22)
            ...
            Category_Dropdown.BackgroundColor3 = RGB(25, 10, 20)
            Category_Dropdown.BorderColor3 = RGB(251, 10, 38)
            ...
            Category_Dropdown_Arrow.BackgroundColor3 = RGB(30, 10, 24)
            ...
            Category_Dropdown.MouseEnter:Connect(function()
                TS:Create(Category_Dropdown, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(30, 10, 24)}):Play()
            end)
        
            Category_Dropdown.MouseLeave:Connect(function()
                TS:Create(Category_Dropdown, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(25, 10, 20)}):Play()
            end)
            ...
            cat_funcs.NewButton = function(button_name, CallBack)
                ...
                Detector.BackgroundColor3 = RGB(25, 10, 20)
                Detector.BackgroundTransparency = 0
                Detector.BorderColor3 = RGB(80, 20, 40)
                ...
                Detector.MouseEnter:Connect(function()
                    TS:Create(Detector, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(30, 10, 24)}):Play()
                ...
                Detector.MouseLeave:Connect(function()
                    TS:Create(Detector, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(25, 10, 20)}):Play()
            ...
            cat_funcs.NewToggle = function(toggle_name, CallBack, info)
                ...
                local function Place_Colors()
                    if current_state then
                        TS:Create(Detector, tween(0.1, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(251, 10, 38)}):Play()
                        TS:Create(Toggle_Bob, tween(0.1, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(255, 255, 255)}):Play()
                        ...
                        TS:Create(Detector, tween(0.1, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(40, 10, 30)}):Play()
            ...
            cat_funcs.NewSlider = function(slider_name, CallBack, info)
                ...
                Detector.BackgroundColor3 = RGB(40, 10, 30)
                ...
                Bar.Name = "Bar"
                Bar.Parent = Detector
                Bar.BackgroundColor3 = RGB(40, 10, 30)
                ...
                Filled.Name = "Filled"
                Filled.Parent = Bar
                Filled.BackgroundColor3 = RGB(251, 10, 38)
            ...
            cat_funcs.NewColorpicker = function(picker_name, CallBack, info)
                ...
                PickerFrame.BackgroundColor3 = RGB(25, 10, 20)
                PickerFrame.BorderColor3 = RGB(80, 20, 40)
                ...
                HSVBox.BorderColor3 = RGB(80, 20, 40)
                ...
                HUEPicker.BorderColor3 = RGB(80, 20, 40)
                ...
                Value1.BackgroundColor3 = RGB(25, 10, 20)
                Value1.BorderColor3 = RGB(80, 20, 40)
                ...
                Value2.BackgroundColor3 = RGB(25, 10, 20)
                Value2.BorderColor3 = RGB(80, 20, 40)
                ...
                Value3.BackgroundColor3 = RGB(25, 10, 20)
                Value3.BorderColor3 = RGB(80, 20, 40)
                ...
                CopyValues.BackgroundColor3 = RGB(25, 10, 20)
                CopyValues.BorderColor3 = RGB(80, 20, 40)
                ...
                CopyValues.MouseEnter:Connect(function()
                    TS:Create(CopyValues, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(30, 10, 24)}):Play()
                end)
            
                CopyValues.MouseLeave:Connect(function()
                    TS:Create(CopyValues, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(25, 10, 20)}):Play()
                end)
            ...
            cat_funcs.NewDropdown = function(dropdown_name, CallBack, info)
                ...
                local function ReMap()
                    ...
                    for _,v in pairs(info.options) do
                        ...
                        Option.BackgroundColor3 = RGB(25, 10, 20)
                        Option.BorderColor3 = RGB(80, 20, 40)
                        ...
                        Option.MouseEnter:Connect(function()
                            TS:Create(Option, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(30, 10, 24)}):Play()
                        end)
                    
                        Option.MouseLeave:Connect(function()
                            TS:Create(Option, tween(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {BackgroundColor3 = RGB(25, 10, 20)}):Play()
                        end)
